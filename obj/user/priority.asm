...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
...
umain(void) {
  ...
  8003d3:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003d6:	e8 31 0d 00 00       	call   80110c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 44 15 80 00       	add    $0x801544,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 68 15 80 00 	mov    0x801568(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 5e 15 80 	movl   $0x80155e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 61 15 80 00       	mov    $0x801561,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8010ed:	eb 12                	jmp    801101 <spin_delay+0x21>
     {
          j = !j;
  8010ef:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8010f2:	85 c0                	test   %eax,%eax
  8010f4:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8010fd:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  801101:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  801108:	75 e5                	jne    8010ef <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  80110f:	53                   	push   %ebx
  801110:	83 e4 f0             	and    $0xfffffff0,%esp
  801113:	83 ec 30             	sub    $0x30,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801116:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  80111d:	00 
  80111e:	c7 04 24 c0 16 80 00 	movl   $0x8016c0,(%esp)
  801125:	e8 f1 ef ff ff       	call   80011b <cprintf>
     sleep(SLEEP_TIME);
  80112a:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801131:	e8 86 f2 ff ff       	call   8003bc <sleep>
     memset(pids, 0, sizeof(pids));
  801136:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  80113d:	00 
  80113e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801145:	00 
  801146:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  80114d:	e8 d1 fd ff ff       	call   800f23 <memset>
     lab6_set_priority(TOTAL + 1);
  801152:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801159:	e8 4b f2 ff ff       	call   8003a9 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  80115e:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801165:	00 
  801166:	e9 04 01 00 00       	jmp    80126f <main+0x163>
          acc[i]=0;
  80116b:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80116f:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  801176:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80117a:	e8 a0 f1 ff ff       	call   80031f <fork>
  80117f:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801183:	89 04 95 30 20 80 00 	mov    %eax,0x802030(,%edx,4)
  80118a:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80118e:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801195:	85 c0                	test   %eax,%eax
  801197:	0f 85 ba 00 00 00    	jne    801257 <main+0x14b>
               lab6_set_priority(i + 1);
  80119d:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011a1:	83 c0 01             	add    $0x1,%eax
  8011a4:	89 04 24             	mov    %eax,(%esp)
  8011a7:	e8 fd f1 ff ff       	call   8003a9 <lab6_set_priority>
               acc[i] = 0;
  8011ac:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011b0:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  8011b7:	00 00 00 00 
  8011bb:	eb 01                	jmp    8011be <main+0xb2>
  ...
  8011bd:	90                   	nop
          ...
          if ((pids[i] = fork()) == 0) {
               ...
               while (1) {
                    spin_delay();
  8011be:	e8 1d ff ff ff       	call   8010e0 <spin_delay>
                    ++ acc[i];
  8011c3:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011c7:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  8011ce:	8d 50 01             	lea    0x1(%eax),%edx
  8011d1:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011d5:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  8011dc:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011e0:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  8011e7:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8011ec:	89 c8                	mov    %ecx,%eax
  8011ee:	f7 e2                	mul    %edx
  8011f0:	89 d0                	mov    %edx,%eax
  8011f2:	c1 e8 08             	shr    $0x8,%eax
  8011f5:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8011fb:	89 ca                	mov    %ecx,%edx
  8011fd:	29 c2                	sub    %eax,%edx
  8011ff:	89 d0                	mov    %edx,%eax
  801201:	85 c0                	test   %eax,%eax
  801203:	75 b8                	jne    8011bd <main+0xb1>
                        if((time=gettime_msec())>MAX_TIME) {
  801205:	e8 92 f1 ff ff       	call   80039c <gettime_msec>
  80120a:	89 44 24 28          	mov    %eax,0x28(%esp)
  80120e:	81 7c 24 28 d0 07 00 	cmpl   $0x7d0,0x28(%esp)
  801215:	00 
  801216:	7e a5                	jle    8011bd <main+0xb1>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801218:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80121c:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  801223:	e8 5a f1 ff ff       	call   800382 <getpid>
  801228:	8b 54 24 28          	mov    0x28(%esp),%edx
  80122c:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801230:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801234:	89 44 24 04          	mov    %eax,0x4(%esp)
  801238:	c7 04 24 e8 16 80 00 	movl   $0x8016e8,(%esp)
  80123f:	e8 d7 ee ff ff       	call   80011b <cprintf>
                            exit(acc[i]);
  801244:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801248:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  80124f:	89 04 24             	mov    %eax,(%esp)
  801252:	e8 a9 f0 ff ff       	call   800300 <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  801257:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80125b:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801262:	85 c0                	test   %eax,%eax
  801264:	0f 88 15 01 00 00    	js     80137f <main+0x273>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80126a:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  80126f:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801274:	0f 8e f1 fe ff ff    	jle    80116b <main+0x5f>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80127a:	c7 04 24 08 17 80 00 	movl   $0x801708,(%esp)
  801281:	e8 95 ee ff ff       	call   80011b <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  801286:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  80128d:	00 
  80128e:	eb 6b                	jmp    8012fb <main+0x1ef>
         status[i]=0;
  801290:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801294:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  80129b:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  80129f:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8012a3:	c1 e0 02             	shl    $0x2,%eax
  8012a6:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  8012ac:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8012b0:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8012b7:	89 54 24 04          	mov    %edx,0x4(%esp)
  8012bb:	89 04 24             	mov    %eax,(%esp)
  8012be:	e8 85 f0 ff ff       	call   800348 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8012c3:	e8 d4 f0 ff ff       	call   80039c <gettime_msec>
  8012c8:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  8012cc:	8b 0c 95 1c 20 80 00 	mov    0x80201c(,%edx,4),%ecx
  8012d3:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  8012d7:	8b 14 95 30 20 80 00 	mov    0x802030(,%edx,4),%edx
  8012de:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012e2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8012e6:	89 54 24 04          	mov    %edx,0x4(%esp)
  8012ea:	c7 04 24 30 17 80 00 	movl   $0x801730,(%esp)
  8012f1:	e8 25 ee ff ff       	call   80011b <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8012f6:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  8012fb:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801300:	7e 8e                	jle    801290 <main+0x184>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801302:	c7 04 24 4f 17 80 00 	movl   $0x80174f,(%esp)
  801309:	e8 0d ee ff ff       	call   80011b <cprintf>
     cprintf("stride sched correct result:");
  80130e:	c7 04 24 65 17 80 00 	movl   $0x801765,(%esp)
  801315:	e8 01 ee ff ff       	call   80011b <cprintf>
     for (i = 0; i < TOTAL; i ++)
  80131a:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801321:	00 
  801322:	eb 41                	jmp    801365 <main+0x259>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801324:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801328:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  80132f:	01 c0                	add    %eax,%eax
  801331:	8b 15 1c 20 80 00    	mov    0x80201c,%edx
  801337:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  80133b:	89 c2                	mov    %eax,%edx
  80133d:	c1 fa 1f             	sar    $0x1f,%edx
  801340:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801344:	83 c0 01             	add    $0x1,%eax
  801347:	89 c2                	mov    %eax,%edx
  801349:	c1 ea 1f             	shr    $0x1f,%edx
  80134c:	01 d0                	add    %edx,%eax
  80134e:	d1 f8                	sar    %eax
  801350:	89 44 24 04          	mov    %eax,0x4(%esp)
  801354:	c7 04 24 82 17 80 00 	movl   $0x801782,(%esp)
  80135b:	e8 bb ed ff ff       	call   80011b <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801360:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801365:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  80136a:	7e b8                	jle    801324 <main+0x218>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  80136c:	c7 04 24 86 17 80 00 	movl   $0x801786,(%esp)
  801373:	e8 a3 ed ff ff       	call   80011b <cprintf>

     return 0;
  801378:	b8 00 00 00 00       	mov    $0x0,%eax
  80137d:	eb 55                	jmp    8013d4 <main+0x2c8>
                    }
               }
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801380:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801387:	00 
  801388:	eb 27                	jmp    8013b1 <main+0x2a5>
          if (pids[i] > 0) {
  80138a:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80138e:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801395:	85 c0                	test   %eax,%eax
  801397:	7e 13                	jle    8013ac <main+0x2a0>
               kill(pids[i]);
  801399:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80139d:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8013a4:	89 04 24             	mov    %eax,(%esp)
  8013a7:	e8 c3 ef ff ff       	call   80036f <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  8013ac:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  8013b1:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  8013b6:	7e d2                	jle    80138a <main+0x27e>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  8013b8:	c7 44 24 08 88 17 80 	movl   $0x801788,0x8(%esp)
  8013bf:	00 
  8013c0:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  8013c7:	00 
  8013c8:	c7 04 24 93 17 80 00 	movl   $0x801793,(%esp)
  8013cf:	e8 5c ec ff ff       	call   800030 <__panic>
}
