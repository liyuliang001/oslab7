...
main(void) {
  ...
  8010f2:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  8010f9:	e8 1d f0 ff ff       	call   80011b <cprintf>
    print_pgdir();
  8010fe:	e8 8c f2 ff ff       	call   80038f <print_pgdir>
    cprintf("pgdir pass.\n");
  801103:	c7 04 24 17 14 80 00 	movl   $0x801417,(%esp)
  80110a:	e8 0c f0 ff ff       	call   80011b <cprintf>
    return 0;
