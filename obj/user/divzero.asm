...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e6:	83 ec 20             	sub    $0x20,%esp
    cprintf("value is %d.\n", 1 / zero);
  8010e9:	8b 15 08 20 80 00    	mov    0x802008,%edx
  8010ef:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  8010f3:	b8 01 00 00 00       	mov    $0x1,%eax
  8010f8:	89 c2                	mov    %eax,%edx
  8010fa:	c1 fa 1f             	sar    $0x1f,%edx
  8010fd:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801101:	89 44 24 04          	mov    %eax,0x4(%esp)
  801105:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  80110c:	e8 0a f0 ff ff       	call   80011b <cprintf>
    panic("FAIL: T.T\n");
  801111:	c7 44 24 08 2e 14 80 	movl   $0x80142e,0x8(%esp)
  801118:	00 
  801119:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801120:	00 
  801121:	c7 04 24 39 14 80 00 	movl   $0x801439,(%esp)
  801128:	e8 03 ef ff ff       	call   800030 <__panic>
