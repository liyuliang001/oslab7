...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 fa 14 80 00 	movl   $0x8014fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 fc 14 80 00 	movl   $0x8014fc,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 fa 14 80 00 	movl   $0x8014fa,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 18 15 80 00 	movl   $0x801518,(%esp)
...
umain(void) {
  ...
  8003d3:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003d6:	e8 3f 0f 00 00       	call   80131a <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 44 16 80 00       	add    $0x801644,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 68 16 80 00 	mov    0x801668(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 5e 16 80 	movl   $0x80165e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 61 16 80 00       	mov    $0x801661,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8010e3:	53                   	push   %ebx
  8010e4:	83 ec 24             	sub    $0x24,%esp
    int i, j, k, size = MATSIZE;
  8010e7:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8010ee:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010f5:	eb 65                	jmp    80115c <work+0x7c>
        for (j = 0; j < size; j ++) {
  8010f7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8010fe:	eb 50                	jmp    801150 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  801100:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801103:	89 d0                	mov    %edx,%eax
  801105:	c1 e0 02             	shl    $0x2,%eax
  801108:	01 d0                	add    %edx,%eax
  80110a:	01 c0                	add    %eax,%eax
  80110c:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80110f:	01 d0                	add    %edx,%eax
  801111:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  801118:	01 00 00 00 
  ...
  80112d:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  801134:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801137:	89 d0                	mov    %edx,%eax
  801139:	c1 e0 02             	shl    $0x2,%eax
  80113c:	01 d0                	add    %edx,%eax
  80113e:	01 c0                	add    %eax,%eax
  801140:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801143:	01 d0                	add    %edx,%eax
  801145:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80114c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801150:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801153:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801156:	7c a8                	jl     801100 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801158:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80115c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80115f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801162:	7c 93                	jl     8010f7 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801164:	e8 f9 f1 ff ff       	call   800362 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801169:	e8 14 f2 ff ff       	call   800382 <getpid>
  80116e:	8b 55 08             	mov    0x8(%ebp),%edx
  801171:	89 54 24 08          	mov    %edx,0x8(%esp)
  801175:	89 44 24 04          	mov    %eax,0x4(%esp)
  801179:	c7 04 24 c0 17 80 00 	movl   $0x8017c0,(%esp)
  801180:	e8 96 ef ff ff       	call   80011b <cprintf>

    while (times -- > 0) {
  801185:	e9 5c 01 00 00       	jmp    8012e6 <work+0x206>
        for (i = 0; i < size; i ++) {
  80118a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801191:	e9 b6 00 00 00       	jmp    80124c <work+0x16c>
            for (j = 0; j < size; j ++) {
  801196:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80119d:	e9 9a 00 00 00       	jmp    80123c <work+0x15c>
                matc[i][j] = 0;
  8011a2:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011a5:	89 d0                	mov    %edx,%eax
  8011a7:	c1 e0 02             	shl    $0x2,%eax
  8011aa:	01 d0                	add    %edx,%eax
  8011ac:	01 c0                	add    %eax,%eax
  8011ae:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8011b1:	01 d0                	add    %edx,%eax
  8011b3:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  8011ba:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8011be:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8011c5:	eb 69                	jmp    801230 <work+0x150>
  ...
  8011d8:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  8011df:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011e2:	89 d0                	mov    %edx,%eax
  8011e4:	c1 e0 02             	shl    $0x2,%eax
  8011e7:	01 d0                	add    %edx,%eax
  8011e9:	01 c0                	add    %eax,%eax
  8011eb:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8011ee:	01 d0                	add    %edx,%eax
  8011f0:	8b 1c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ebx
  8011f7:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8011fa:	89 d0                	mov    %edx,%eax
  8011fc:	c1 e0 02             	shl    $0x2,%eax
  8011ff:	01 d0                	add    %edx,%eax
  801201:	01 c0                	add    %eax,%eax
  801203:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801206:	01 d0                	add    %edx,%eax
  801208:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  80120f:	0f af c3             	imul   %ebx,%eax
  801212:	01 c1                	add    %eax,%ecx
  ...
  801225:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  80122c:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  801230:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801233:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801236:	7c 8f                	jl     8011c7 <work+0xe7>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801238:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80123c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80123f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801242:	0f 8c 5a ff ff ff    	jl     8011a2 <work+0xc2>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801248:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80124c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80124f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801252:	0f 8c 3e ff ff ff    	jl     801196 <work+0xb6>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  801258:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80125f:	eb 79                	jmp    8012da <work+0x1fa>
            for (j = 0; j < size; j ++) {
  801261:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801268:	eb 64                	jmp    8012ce <work+0x1ee>
  ...
  8012c3:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
        ...
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8012ca:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8012ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8012d1:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8012d4:	7c 94                	jl     80126a <work+0x18a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8012d6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8012da:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8012dd:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8012e0:	0f 8c 7b ff ff ff    	jl     801261 <work+0x181>
  ...
  8012ea:	0f 95 c0             	setne  %al
  8012ed:	83 6d 08 01          	subl   $0x1,0x8(%ebp)
  8012f1:	84 c0                	test   %al,%al
  8012f3:	0f 85 91 fe ff ff    	jne    80118a <work+0xaa>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8012f9:	e8 84 f0 ff ff       	call   800382 <getpid>
  8012fe:	89 44 24 04          	mov    %eax,0x4(%esp)
  801302:	c7 04 24 e0 17 80 00 	movl   $0x8017e0,(%esp)
  801309:	e8 0d ee ff ff       	call   80011b <cprintf>
    exit(0);
  80130e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801315:	e8 e6 ef ff ff       	call   800300 <exit>
...
int
main(void) {
  80131a:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80131e:	83 e4 f0             	and    $0xfffffff0,%esp
  801321:	ff 71 fc             	pushl  -0x4(%ecx)
  801324:	55                   	push   %ebp
  801325:	89 e5                	mov    %esp,%ebp
  801327:	53                   	push   %ebx
  801328:	51                   	push   %ecx
  801329:	83 ec 30             	sub    $0x30,%esp
  80132c:	89 e0                	mov    %esp,%eax
  80132e:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801330:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  801335:	83 e8 01             	sub    $0x1,%eax
  801338:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80133b:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  801340:	c1 e0 02             	shl    $0x2,%eax
  801343:	8d 50 03             	lea    0x3(%eax),%edx
  801346:	b8 10 00 00 00       	mov    $0x10,%eax
  80134b:	83 e8 01             	sub    $0x1,%eax
  80134e:	01 d0                	add    %edx,%eax
  801350:	c7 45 e4 10 00 00 00 	movl   $0x10,-0x1c(%ebp)
  801357:	ba 00 00 00 00       	mov    $0x0,%edx
  80135c:	f7 75 e4             	divl   -0x1c(%ebp)
  80135f:	6b c0 10             	imul   $0x10,%eax,%eax
  801362:	29 c4                	sub    %eax,%esp
  801364:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801368:	83 c0 03             	add    $0x3,%eax
  80136b:	c1 e8 02             	shr    $0x2,%eax
  80136e:	c1 e0 02             	shl    $0x2,%eax
  801371:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  801374:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  801379:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801380:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801383:	89 54 24 08          	mov    %edx,0x8(%esp)
  801387:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80138e:	00 
  80138f:	89 04 24             	mov    %eax,(%esp)
  801392:	e8 8c fb ff ff       	call   800f23 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801397:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80139e:	eb 71                	jmp    801411 <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  8013a0:	e8 7a ef ff ff       	call   80031f <fork>
  8013a5:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8013a8:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8013ab:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  8013ae:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013b1:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013b4:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013b7:	85 c0                	test   %eax,%eax
  8013b9:	75 45                	jne    801400 <main+0xe6>
            srand(i * i);
  8013bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8013be:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  8013c2:	89 04 24             	mov    %eax,(%esp)
  8013c5:	e8 00 f8 ff ff       	call   800bca <srand>
            int times = (((unsigned int)rand()) % total);
  8013ca:	e8 11 f7 ff ff       	call   800ae0 <rand>
  8013cf:	8b 15 f0 17 80 00    	mov    0x8017f0,%edx
  ...
  8013e3:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8013e6:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8013ea:	6b c0 64             	imul   $0x64,%eax,%eax
  8013ed:	05 e8 03 00 00       	add    $0x3e8,%eax
  8013f2:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8013f5:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8013f8:	89 04 24             	mov    %eax,(%esp)
  8013fb:	e8 e0 fc ff ff       	call   8010e0 <work>
        }
        if (pids[i] < 0) {
  801400:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801403:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801406:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801409:	85 c0                	test   %eax,%eax
  80140b:	78 5d                	js     80146a <main+0x150>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  80140d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801411:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  801416:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801419:	7c 85                	jl     8013a0 <main+0x86>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  80141b:	c7 04 24 f4 17 80 00 	movl   $0x8017f4,(%esp)
  801422:	e8 f4 ec ff ff       	call   80011b <cprintf>

    for (i = 0; i < total; i ++) {
  801427:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80142e:	eb 1b                	jmp    80144b <main+0x131>
        if (wait() != 0) {
  801430:	e8 f7 ee ff ff       	call   80032c <wait>
  801435:	85 c0                	test   %eax,%eax
  801437:	74 0e                	je     801447 <main+0x12d>
            cprintf("wait failed.\n");
  801439:	c7 04 24 fe 17 80 00 	movl   $0x8017fe,(%esp)
  801440:	e8 d6 ec ff ff       	call   80011b <cprintf>
            goto failed;
  801445:	eb 24                	jmp    80146b <main+0x151>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801447:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80144b:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  801450:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801453:	7c db                	jl     801430 <main+0x116>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801455:	c7 04 24 0c 18 80 00 	movl   $0x80180c,(%esp)
  80145c:	e8 ba ec ff ff       	call   80011b <cprintf>
    return 0;
  801461:	b8 00 00 00 00       	mov    $0x0,%eax
  801466:	89 dc                	mov    %ebx,%esp
  801468:	eb 52                	jmp    8014bc <main+0x1a2>
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
        }
...
failed:
    for (i = 0; i < total; i ++) {
  801492:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801496:	a1 f0 17 80 00       	mov    0x8017f0,%eax
  80149b:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80149e:	7c d4                	jl     801474 <main+0x15a>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  8014a0:	c7 44 24 08 1a 18 80 	movl   $0x80181a,0x8(%esp)
  8014a7:	00 
  8014a8:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  8014af:	00 
  8014b0:	c7 04 24 25 18 80 00 	movl   $0x801825,(%esp)
  8014b7:	e8 74 eb ff ff       	call   800030 <__panic>
}
  8014bc:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8014bf:	59                   	pop    %ecx
  8014c0:	5b                   	pop    %ebx
  8014c1:	5d                   	pop    %ebp
  8014c2:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8014c5:	c3                   	ret    
