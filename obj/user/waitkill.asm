...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 80 12 80 00 	movl   $0x801280,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 9a 12 80 00 	movl   $0x80129a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 9c 12 80 00 	movl   $0x80129c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 9a 12 80 00 	movl   $0x80129a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 b8 12 80 00 	movl   $0x8012b8,(%esp)
...
umain(void) {
  ...
  8003d3:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003d6:	e8 ad 0d 00 00       	call   801188 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 e4 13 80 00       	add    $0x8013e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 08 14 80 00 	mov    0x801408(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 fe 13 80 	movl   $0x8013fe,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 01 14 80 00       	mov    $0x801401,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8010e3:	83 ec 08             	sub    $0x8,%esp
    yield();
  8010e6:	e8 77 f2 ff ff       	call   800362 <yield>
    yield();
  8010eb:	e8 72 f2 ff ff       	call   800362 <yield>
    yield();
  8010f0:	e8 6d f2 ff ff       	call   800362 <yield>
    yield();
  8010f5:	e8 68 f2 ff ff       	call   800362 <yield>
    yield();
  8010fa:	e8 63 f2 ff ff       	call   800362 <yield>
    yield();
  8010ff:	e8 5e f2 ff ff       	call   800362 <yield>
}
  801104:	c9                   	leave  
  801105:	c3                   	ret    
...
loop(void) {
  ...
  801109:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  80110c:	c7 04 24 60 15 80 00 	movl   $0x801560,(%esp)
  801113:	e8 03 f0 ff ff       	call   80011b <cprintf>
    while (1);
  801118:	eb fe                	jmp    801118 <loop+0x12>
...
work(void) {
  ...
  80111d:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801120:	c7 04 24 6a 15 80 00 	movl   $0x80156a,(%esp)
  801127:	e8 ef ef ff ff       	call   80011b <cprintf>
    do_yield();
  80112c:	e8 af ff ff ff       	call   8010e0 <do_yield>
    if (kill(parent) == 0) {
  801131:	a1 08 20 80 00       	mov    0x802008,%eax
  801136:	89 04 24             	mov    %eax,(%esp)
  801139:	e8 31 f2 ff ff       	call   80036f <kill>
  80113e:	85 c0                	test   %eax,%eax
  801140:	75 3a                	jne    80117c <work+0x62>
        cprintf("kill parent ok.\n");
  801142:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  801149:	e8 cd ef ff ff       	call   80011b <cprintf>
        do_yield();
  80114e:	e8 8d ff ff ff       	call   8010e0 <do_yield>
        if (kill(pid1) == 0) {
  801153:	a1 10 20 80 00       	mov    0x802010,%eax
  801158:	89 04 24             	mov    %eax,(%esp)
  80115b:	e8 0f f2 ff ff       	call   80036f <kill>
  801160:	85 c0                	test   %eax,%eax
  801162:	75 18                	jne    80117c <work+0x62>
            cprintf("kill child1 ok.\n");
  801164:	c7 04 24 85 15 80 00 	movl   $0x801585,(%esp)
  80116b:	e8 ab ef ff ff       	call   80011b <cprintf>
            exit(0);
  801170:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801177:	e8 84 f1 ff ff       	call   800300 <exit>
        }
    }
    exit(-1);
  80117c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801183:	e8 78 f1 ff ff       	call   800300 <exit>
...
main(void) {
  ...
  80118e:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801191:	e8 ec f1 ff ff       	call   800382 <getpid>
  801196:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80119b:	e8 7f f1 ff ff       	call   80031f <fork>
  8011a0:	a3 10 20 80 00       	mov    %eax,0x802010
  8011a5:	a1 10 20 80 00       	mov    0x802010,%eax
  8011aa:	85 c0                	test   %eax,%eax
  8011ac:	75 05                	jne    8011b3 <main+0x2b>
        loop();
  8011ae:	e8 53 ff ff ff       	call   801106 <loop>
    }

    assert(pid1 > 0);
  8011b3:	a1 10 20 80 00       	mov    0x802010,%eax
  8011b8:	85 c0                	test   %eax,%eax
  8011ba:	7f 24                	jg     8011e0 <main+0x58>
  8011bc:	c7 44 24 0c 96 15 80 	movl   $0x801596,0xc(%esp)
  8011c3:	00 
  8011c4:	c7 44 24 08 9f 15 80 	movl   $0x80159f,0x8(%esp)
  8011cb:	00 
  8011cc:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8011d3:	00 
  8011d4:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  8011db:	e8 50 ee ff ff       	call   800030 <__panic>

    if ((pid2 = fork()) == 0) {
  8011e0:	e8 3a f1 ff ff       	call   80031f <fork>
  8011e5:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8011ea:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011ef:	85 c0                	test   %eax,%eax
  8011f1:	75 05                	jne    8011f8 <main+0x70>
        work();
  8011f3:	e8 22 ff ff ff       	call   80111a <work>
    }
    if (pid2 > 0) {
  8011f8:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011fd:	85 c0                	test   %eax,%eax
  8011ff:	7e 46                	jle    801247 <main+0xbf>
        cprintf("wait child 1.\n");
  801201:	c7 04 24 c4 15 80 00 	movl   $0x8015c4,(%esp)
  801208:	e8 0e ef ff ff       	call   80011b <cprintf>
        waitpid(pid1, NULL);
  80120d:	a1 10 20 80 00       	mov    0x802010,%eax
  801212:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801219:	00 
  80121a:	89 04 24             	mov    %eax,(%esp)
  80121d:	e8 26 f1 ff ff       	call   800348 <waitpid>
        panic("waitpid %d returns\n", pid1);
  801222:	a1 10 20 80 00       	mov    0x802010,%eax
  801227:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80122b:	c7 44 24 08 d3 15 80 	movl   $0x8015d3,0x8(%esp)
  801232:	00 
  801233:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80123a:	00 
  80123b:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  801242:	e8 e9 ed ff ff       	call   800030 <__panic>
    }
    else {
        kill(pid1);
  801247:	a1 10 20 80 00       	mov    0x802010,%eax
  80124c:	89 04 24             	mov    %eax,(%esp)
  80124f:	e8 1b f1 ff ff       	call   80036f <kill>
    }
    panic("FAIL: T.T\n");
  801254:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  80125b:	00 
  80125c:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801263:	00 
  801264:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  80126b:	e8 c0 ed ff ff       	call   800030 <__panic>
