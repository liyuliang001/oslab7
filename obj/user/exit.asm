...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 60 12 80 00 	movl   $0x801260,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 7a 12 80 00 	movl   $0x80127a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 7c 12 80 00 	movl   $0x80127c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 7a 12 80 00 	movl   $0x80127a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 c4 13 80 00       	add    $0x8013c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 e8 13 80 00 	mov    0x8013e8(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 de 13 80 	movl   $0x8013de,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be e1 13 80 00       	mov    $0x8013e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e9:	c7 04 24 40 15 80 00 	movl   $0x801540,(%esp)
  8010f0:	e8 26 f0 ff ff       	call   80011b <cprintf>
    if ((pid = fork()) == 0) {
  8010f5:	e8 25 f2 ff ff       	call   80031f <fork>
  8010fa:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8010fe:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801103:	75 3c                	jne    801141 <main+0x61>
        cprintf("I am the child.\n");
  801105:	c7 04 24 67 15 80 00 	movl   $0x801567,(%esp)
  80110c:	e8 0a f0 ff ff       	call   80011b <cprintf>
        yield();
  801111:	e8 4c f2 ff ff       	call   800362 <yield>
        yield();
  801116:	e8 47 f2 ff ff       	call   800362 <yield>
        yield();
  80111b:	e8 42 f2 ff ff       	call   800362 <yield>
        yield();
  801120:	e8 3d f2 ff ff       	call   800362 <yield>
        yield();
  801125:	e8 38 f2 ff ff       	call   800362 <yield>
        yield();
  80112a:	e8 33 f2 ff ff       	call   800362 <yield>
        yield();
  80112f:	e8 2e f2 ff ff       	call   800362 <yield>
        exit(magic);
  801134:	a1 08 20 80 00       	mov    0x802008,%eax
  801139:	89 04 24             	mov    %eax,(%esp)
  80113c:	e8 bf f1 ff ff       	call   800300 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801141:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801145:	89 44 24 04          	mov    %eax,0x4(%esp)
  801149:	c7 04 24 78 15 80 00 	movl   $0x801578,(%esp)
  801150:	e8 c6 ef ff ff       	call   80011b <cprintf>
    }
    assert(pid > 0);
  801155:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80115a:	7f 24                	jg     801180 <main+0xa0>
  80115c:	c7 44 24 0c 9a 15 80 	movl   $0x80159a,0xc(%esp)
  801163:	00 
  801164:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  80116b:	00 
  80116c:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801173:	00 
  801174:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  80117b:	e8 b0 ee ff ff       	call   800030 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801180:	c7 04 24 c4 15 80 00 	movl   $0x8015c4,(%esp)
  801187:	e8 8f ef ff ff       	call   80011b <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  80118c:	8d 44 24 18          	lea    0x18(%esp),%eax
  801190:	89 44 24 04          	mov    %eax,0x4(%esp)
  801194:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801198:	89 04 24             	mov    %eax,(%esp)
  80119b:	e8 a8 f1 ff ff       	call   800348 <waitpid>
  8011a0:	85 c0                	test   %eax,%eax
  8011a2:	75 0d                	jne    8011b1 <main+0xd1>
  8011a4:	8b 54 24 18          	mov    0x18(%esp),%edx
  8011a8:	a1 08 20 80 00       	mov    0x802008,%eax
  8011ad:	39 c2                	cmp    %eax,%edx
  8011af:	74 24                	je     8011d5 <main+0xf5>
  8011b1:	c7 44 24 0c e4 15 80 	movl   $0x8015e4,0xc(%esp)
  8011b8:	00 
  8011b9:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  8011c0:	00 
  8011c1:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8011c8:	00 
  8011c9:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  8011d0:	e8 5b ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8011d5:	8d 44 24 18          	lea    0x18(%esp),%eax
  8011d9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011dd:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011e1:	89 04 24             	mov    %eax,(%esp)
  8011e4:	e8 5f f1 ff ff       	call   800348 <waitpid>
  8011e9:	85 c0                	test   %eax,%eax
  8011eb:	74 09                	je     8011f6 <main+0x116>
  8011ed:	e8 3a f1 ff ff       	call   80032c <wait>
  8011f2:	85 c0                	test   %eax,%eax
  8011f4:	75 24                	jne    80121a <main+0x13a>
  8011f6:	c7 44 24 0c 10 16 80 	movl   $0x801610,0xc(%esp)
  8011fd:	00 
  8011fe:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  801205:	00 
  801206:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80120d:	00 
  80120e:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  801215:	e8 16 ee ff ff       	call   800030 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  80121a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80121e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801222:	c7 04 24 38 16 80 00 	movl   $0x801638,(%esp)
  801229:	e8 ed ee ff ff       	call   80011b <cprintf>

    cprintf("exit pass.\n");
  80122e:	c7 04 24 48 16 80 00 	movl   $0x801648,(%esp)
  801235:	e8 e1 ee ff ff       	call   80011b <cprintf>
    return 0;
