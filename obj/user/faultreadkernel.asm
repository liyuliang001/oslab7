...
main(void) {
  ...
  8010e9:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8010ee:	8b 00                	mov    (%eax),%eax
  8010f0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f4:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  8010fb:	e8 1b f0 ff ff       	call   80011b <cprintf>
    panic("FAIL: T.T\n");
  801100:	c7 44 24 08 1e 14 80 	movl   $0x80141e,0x8(%esp)
  801107:	00 
  801108:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  80110f:	00 
  801110:	c7 04 24 29 14 80 00 	movl   $0x801429,(%esp)
  801117:	e8 14 ef ff ff       	call   800030 <__panic>
