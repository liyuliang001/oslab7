...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 40 12 80 00 	movl   $0x801240,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 5a 12 80 00 	movl   $0x80125a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 5c 12 80 00 	movl   $0x80125c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 5a 12 80 00 	movl   $0x80125a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 78 12 80 00 	movl   $0x801278,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 a4 13 80 00       	add    $0x8013a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 c8 13 80 00 	mov    0x8013c8(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 be 13 80 	movl   $0x8013be,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be c1 13 80 00       	mov    $0x8013c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e6:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8010e9:	e8 31 f2 ff ff       	call   80031f <fork>
  8010ee:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010f2:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010f7:	75 33                	jne    80112c <main+0x4c>
        cprintf("fork ok.\n");
  8010f9:	c7 04 24 20 15 80 00 	movl   $0x801520,(%esp)
  801100:	e8 16 f0 ff ff       	call   80011b <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  801105:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80110c:	00 
  80110d:	eb 0a                	jmp    801119 <main+0x39>
            yield();
  80110f:	e8 4e f2 ff ff       	call   800362 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  801114:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801119:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  80111e:	7e ef                	jle    80110f <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  801120:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  801127:	e8 d4 f1 ff ff       	call   800300 <exit>
    }
    assert(pid > 0);
  80112c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801131:	7f 24                	jg     801157 <main+0x77>
  801133:	c7 44 24 0c 2a 15 80 	movl   $0x80152a,0xc(%esp)
  80113a:	00 
  80113b:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  801142:	00 
  801143:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80114a:	00 
  80114b:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  801152:	e8 d9 ee ff ff       	call   800030 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801157:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80115e:	00 
  80115f:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801166:	e8 dd f1 ff ff       	call   800348 <waitpid>
  80116b:	85 c0                	test   %eax,%eax
  80116d:	75 24                	jne    801193 <main+0xb3>
  80116f:	c7 44 24 0c 55 15 80 	movl   $0x801555,0xc(%esp)
  801176:	00 
  801177:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  80117e:	00 
  80117f:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801186:	00 
  801187:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  80118e:	e8 9d ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801193:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  80119a:	c0 
  80119b:	8b 44 24 18          	mov    0x18(%esp),%eax
  80119f:	89 04 24             	mov    %eax,(%esp)
  8011a2:	e8 a1 f1 ff ff       	call   800348 <waitpid>
  8011a7:	85 c0                	test   %eax,%eax
  8011a9:	75 24                	jne    8011cf <main+0xef>
  8011ab:	c7 44 24 0c 6c 15 80 	movl   $0x80156c,0xc(%esp)
  8011b2:	00 
  8011b3:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  8011ba:	00 
  8011bb:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8011c2:	00 
  8011c3:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  8011ca:	e8 61 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8011cf:	8d 44 24 14          	lea    0x14(%esp),%eax
  8011d3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011d7:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011db:	89 04 24             	mov    %eax,(%esp)
  8011de:	e8 65 f1 ff ff       	call   800348 <waitpid>
  8011e3:	85 c0                	test   %eax,%eax
  8011e5:	75 0b                	jne    8011f2 <main+0x112>
  8011e7:	8b 44 24 14          	mov    0x14(%esp),%eax
  8011eb:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8011f0:	74 24                	je     801216 <main+0x136>
  8011f2:	c7 44 24 0c 94 15 80 	movl   $0x801594,0xc(%esp)
  8011f9:	00 
  8011fa:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  801201:	00 
  801202:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801209:	00 
  80120a:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  801211:	e8 1a ee ff ff       	call   800030 <__panic>
    cprintf("badarg pass.\n");
  801216:	c7 04 24 c9 15 80 00 	movl   $0x8015c9,(%esp)
  80121d:	e8 f9 ee ff ff       	call   80011b <cprintf>
    return 0;
