...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 fc 11 80 00 	movl   $0x8011fc,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
umain(void) {
  ...
  8003d3:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003d6:	e8 59 0d 00 00       	call   801134 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8010e3:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8010e6:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8010ed:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010f4:	eb 2c                	jmp    801122 <sleepy+0x42>
        sleep(time);
  8010f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8010f9:	89 04 24             	mov    %eax,(%esp)
  8010fc:	e8 bb f2 ff ff       	call   8003bc <sleep>
  ...
  801112:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  801119:	e8 fd ef ff ff       	call   80011b <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
  ...
  801122:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801126:	7e ce                	jle    8010f6 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  801128:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80112f:	e8 cc f1 ff ff       	call   800300 <exit>
...
main(void) {
  ...
  801137:	83 e4 f0             	and    $0xfffffff0,%esp
  80113a:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  80113d:	e8 5a f2 ff ff       	call   80039c <gettime_msec>
  801142:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801146:	e8 d4 f1 ff ff       	call   80031f <fork>
  80114b:	89 44 24 18          	mov    %eax,0x18(%esp)
  80114f:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801154:	75 0c                	jne    801162 <main+0x2e>
        sleepy(pid1);
  801156:	8b 44 24 18          	mov    0x18(%esp),%eax
  80115a:	89 04 24             	mov    %eax,(%esp)
  80115d:	e8 7e ff ff ff       	call   8010e0 <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  801162:	8d 44 24 14          	lea    0x14(%esp),%eax
  801166:	89 44 24 04          	mov    %eax,0x4(%esp)
  80116a:	8b 44 24 18          	mov    0x18(%esp),%eax
  80116e:	89 04 24             	mov    %eax,(%esp)
  801171:	e8 d2 f1 ff ff       	call   800348 <waitpid>
  801176:	85 c0                	test   %eax,%eax
  801178:	75 08                	jne    801182 <main+0x4e>
  80117a:	8b 44 24 14          	mov    0x14(%esp),%eax
  80117e:	85 c0                	test   %eax,%eax
  801180:	74 24                	je     8011a6 <main+0x72>
  801182:	c7 44 24 0c d8 14 80 	movl   $0x8014d8,0xc(%esp)
  801189:	00 
  80118a:	c7 44 24 08 09 15 80 	movl   $0x801509,0x8(%esp)
  801191:	00 
  801192:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801199:	00 
  80119a:	c7 04 24 1e 15 80 00 	movl   $0x80151e,(%esp)
  8011a1:	e8 8a ee ff ff       	call   800030 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  8011a6:	e8 f1 f1 ff ff       	call   80039c <gettime_msec>
  8011ab:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  8011af:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011b3:	c7 04 24 2b 15 80 00 	movl   $0x80152b,(%esp)
  8011ba:	e8 5c ef ff ff       	call   80011b <cprintf>
    cprintf("sleep pass.\n");
  8011bf:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  8011c6:	e8 50 ef ff ff       	call   80011b <cprintf>
    return 0;
