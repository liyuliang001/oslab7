...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 00 12 80 00 	movl   $0x801200,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 1a 12 80 00 	movl   $0x80121a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 1c 12 80 00 	movl   $0x80121c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 1a 12 80 00 	movl   $0x80121a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 64 13 80 00       	add    $0x801364,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 88 13 80 00 	mov    0x801388(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 81 13 80 00       	mov    $0x801381,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e9:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
  8010f0:	e8 26 f0 ff ff       	call   80011b <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010f5:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010fc:	00 
  8010fd:	eb 38                	jmp    801137 <main+0x57>
        if (bigarray[i] != 0) {
  8010ff:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801103:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  80110a:	85 c0                	test   %eax,%eax
  80110c:	74 24                	je     801132 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  80110e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801112:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801116:	c7 44 24 08 00 15 80 	movl   $0x801500,0x8(%esp)
  80111d:	00 
  80111e:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801125:	00 
  801126:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  80112d:	e8 fe ee ff ff       	call   800030 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801132:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801137:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80113e:	00 
  80113f:	7e be                	jle    8010ff <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801141:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801148:	00 
  801149:	eb 14                	jmp    80115f <main+0x7f>
        bigarray[i] = i;
  80114b:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80114f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801153:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80115a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80115f:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801166:	00 
  801167:	7e e2                	jle    80114b <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801169:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801170:	00 
  801171:	eb 3c                	jmp    8011af <main+0xcf>
        if (bigarray[i] != i) {
  801173:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801177:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  80117e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801182:	39 c2                	cmp    %eax,%edx
  801184:	74 24                	je     8011aa <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801186:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80118a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80118e:	c7 44 24 08 2c 15 80 	movl   $0x80152c,0x8(%esp)
  801195:	00 
  801196:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  80119d:	00 
  80119e:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  8011a5:	e8 86 ee ff ff       	call   800030 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  8011aa:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8011af:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8011b6:	00 
  8011b7:	7e ba                	jle    801173 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8011b9:	c7 04 24 54 15 80 00 	movl   $0x801554,(%esp)
  8011c0:	e8 56 ef ff ff       	call   80011b <cprintf>
    cprintf("testbss may pass.\n");
  8011c5:	c7 04 24 87 15 80 00 	movl   $0x801587,(%esp)
  8011cc:	e8 4a ef ff ff       	call   80011b <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8011d1:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8011d8:	00 00 00 
    asm volatile ("int $0x14");
  8011db:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8011dd:	c7 44 24 08 9a 15 80 	movl   $0x80159a,0x8(%esp)
  8011e4:	00 
  8011e5:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8011ec:	00 
  8011ed:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  8011f4:	e8 37 ee ff ff       	call   800030 <__panic>
