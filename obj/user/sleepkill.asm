...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ee:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8010f2:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010f7:	75 18                	jne    801111 <main+0x31>
        sleep(~0);
  8010f9:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801100:	e8 b7 f2 ff ff       	call   8003bc <sleep>
        exit(0xdead);
  801105:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  80110c:	e8 ef f1 ff ff       	call   800300 <exit>
    }
    assert(pid > 0);
  801111:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801116:	7f 24                	jg     80113c <main+0x5c>
  801118:	c7 44 24 0c 80 14 80 	movl   $0x801480,0xc(%esp)
  80111f:	00 
  801120:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  801127:	00 
  801128:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  80112f:	00 
  801130:	c7 04 24 9d 14 80 00 	movl   $0x80149d,(%esp)
  801137:	e8 f4 ee ff ff       	call   800030 <__panic>

    sleep(100);
  80113c:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801143:	e8 74 f2 ff ff       	call   8003bc <sleep>
    assert(kill(pid) == 0);
  801148:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80114c:	89 04 24             	mov    %eax,(%esp)
  80114f:	e8 1b f2 ff ff       	call   80036f <kill>
  801154:	85 c0                	test   %eax,%eax
  801156:	74 24                	je     80117c <main+0x9c>
  801158:	c7 44 24 0c ae 14 80 	movl   $0x8014ae,0xc(%esp)
  80115f:	00 
  801160:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  801167:	00 
  801168:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80116f:	00 
  801170:	c7 04 24 9d 14 80 00 	movl   $0x80149d,(%esp)
  801177:	e8 b4 ee ff ff       	call   800030 <__panic>
    cprintf("sleepkill pass.\n");
  80117c:	c7 04 24 bd 14 80 00 	movl   $0x8014bd,(%esp)
  801183:	e8 93 ef ff ff       	call   80011b <cprintf>
    return 0;
