...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 da 11 80 00 	movl   $0x8011da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 dc 11 80 00 	movl   $0x8011dc,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 da 11 80 00 	movl   $0x8011da,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 f8 11 80 00 	movl   $0x8011f8,(%esp)
...
umain(void) {
  ...
  8003d3:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003d6:	e8 bc 0d 00 00       	call   801197 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 24 13 80 00       	add    $0x801324,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 48 13 80 00 	mov    0x801348(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 3e 13 80 	movl   $0x80133e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be 41 13 80 00       	mov    $0x801341,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  8010e3:	83 ec 48             	sub    $0x48,%esp
  8010e6:	8b 45 0c             	mov    0xc(%ebp),%eax
  8010e9:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8010ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8010ef:	89 04 24             	mov    %eax,(%esp)
  8010f2:	e8 ed fa ff ff       	call   800be4 <strlen>
  8010f7:	83 f8 03             	cmp    $0x3,%eax
  8010fa:	77 4f                	ja     80114b <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8010fc:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801100:	89 44 24 10          	mov    %eax,0x10(%esp)
  801104:	8b 45 08             	mov    0x8(%ebp),%eax
  801107:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80110b:	c7 44 24 08 a0 14 80 	movl   $0x8014a0,0x8(%esp)
  801112:	00 
  801113:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  80111a:	00 
  80111b:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80111e:	89 04 24             	mov    %eax,(%esp)
  801121:	e8 20 f9 ff ff       	call   800a46 <snprintf>
    if (fork() == 0) {
  801126:	e8 f4 f1 ff ff       	call   80031f <fork>
  80112b:	85 c0                	test   %eax,%eax
  80112d:	75 1c                	jne    80114b <forkchild+0x6b>
        forktree(nxt);
  80112f:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801132:	89 04 24             	mov    %eax,(%esp)
  801135:	e8 13 00 00 00       	call   80114d <forktree>
        yield();
  80113a:	e8 23 f2 ff ff       	call   800362 <yield>
        exit(0);
  80113f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801146:	e8 b5 f1 ff ff       	call   800300 <exit>
    }
}
  80114b:	c9                   	leave  
  80114c:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801150:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801153:	e8 2a f2 ff ff       	call   800382 <getpid>
  801158:	8b 55 08             	mov    0x8(%ebp),%edx
  80115b:	89 54 24 08          	mov    %edx,0x8(%esp)
  80115f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801163:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  80116a:	e8 ac ef ff ff       	call   80011b <cprintf>

    forkchild(cur, '0');
  80116f:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801176:	00 
  801177:	8b 45 08             	mov    0x8(%ebp),%eax
  80117a:	89 04 24             	mov    %eax,(%esp)
  80117d:	e8 5e ff ff ff       	call   8010e0 <forkchild>
    forkchild(cur, '1');
  801182:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801189:	00 
  80118a:	8b 45 08             	mov    0x8(%ebp),%eax
  80118d:	89 04 24             	mov    %eax,(%esp)
  801190:	e8 4b ff ff ff       	call   8010e0 <forkchild>
}
  801195:	c9                   	leave  
  801196:	c3                   	ret    
...
main(void) {
  ...
  80119a:	83 e4 f0             	and    $0xfffffff0,%esp
  80119d:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  8011a0:	c7 04 24 b6 14 80 00 	movl   $0x8014b6,(%esp)
  8011a7:	e8 a1 ff ff ff       	call   80114d <forktree>
    return 0;
