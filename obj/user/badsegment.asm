...
main(void) {
  ...
  8010e9:	66 b8 28 00          	mov    $0x28,%ax
  8010ed:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8010ef:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  8010f6:	00 
  8010f7:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8010fe:	00 
  8010ff:	c7 04 24 0b 14 80 00 	movl   $0x80140b,(%esp)
  801106:	e8 25 ef ff ff       	call   800030 <__panic>
