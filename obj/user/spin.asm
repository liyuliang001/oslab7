...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 20 12 80 00 	movl   $0x801220,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 3a 12 80 00 	movl   $0x80123a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 3c 12 80 00 	movl   $0x80123c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 3a 12 80 00 	movl   $0x80123a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 84 13 80 00       	add    $0x801384,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 a8 13 80 00 	mov    0x8013a8(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 9e 13 80 	movl   $0x80139e,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be a1 13 80 00       	mov    $0x8013a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e9:	c7 04 24 00 15 80 00 	movl   $0x801500,(%esp)
  ...
  801103:	75 0e                	jne    801113 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  801105:	c7 04 24 27 15 80 00 	movl   $0x801527,(%esp)
  80110c:	e8 0a f0 ff ff       	call   80011b <cprintf>
        while (1);
  801111:	eb fe                	jmp    801111 <main+0x31>
    }else if (pid<0) {
  801113:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801118:	79 1c                	jns    801136 <main+0x56>
        panic("fork child error\n");
  80111a:	c7 44 24 08 45 15 80 	movl   $0x801545,0x8(%esp)
  801121:	00 
  801122:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  801129:	00 
  80112a:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  801131:	e8 fa ee ff ff       	call   800030 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  801136:	c7 04 24 64 15 80 00 	movl   $0x801564,(%esp)
  80113d:	e8 d9 ef ff ff       	call   80011b <cprintf>

    yield();
  801142:	e8 1b f2 ff ff       	call   800362 <yield>
    yield();
  801147:	e8 16 f2 ff ff       	call   800362 <yield>
    yield();
  80114c:	e8 11 f2 ff ff       	call   800362 <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  801151:	c7 04 24 8c 15 80 00 	movl   $0x80158c,(%esp)
  801158:	e8 be ef ff ff       	call   80011b <cprintf>

    assert((ret = kill(pid)) == 0);
  80115d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801161:	89 04 24             	mov    %eax,(%esp)
  801164:	e8 06 f2 ff ff       	call   80036f <kill>
  801169:	89 44 24 18          	mov    %eax,0x18(%esp)
  80116d:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801172:	74 24                	je     801198 <main+0xb8>
  801174:	c7 44 24 0c b4 15 80 	movl   $0x8015b4,0xc(%esp)
  80117b:	00 
  80117c:	c7 44 24 08 cb 15 80 	movl   $0x8015cb,0x8(%esp)
  801183:	00 
  801184:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80118b:	00 
  80118c:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  801193:	e8 98 ee ff ff       	call   800030 <__panic>
    cprintf("kill returns %d\n", ret);
  801198:	8b 44 24 18          	mov    0x18(%esp),%eax
  80119c:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011a0:	c7 04 24 e0 15 80 00 	movl   $0x8015e0,(%esp)
  8011a7:	e8 6f ef ff ff       	call   80011b <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  8011ac:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8011b3:	00 
  8011b4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011b8:	89 04 24             	mov    %eax,(%esp)
  8011bb:	e8 88 f1 ff ff       	call   800348 <waitpid>
  8011c0:	89 44 24 18          	mov    %eax,0x18(%esp)
  8011c4:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8011c9:	74 24                	je     8011ef <main+0x10f>
  8011cb:	c7 44 24 0c f4 15 80 	movl   $0x8015f4,0xc(%esp)
  8011d2:	00 
  8011d3:	c7 44 24 08 cb 15 80 	movl   $0x8015cb,0x8(%esp)
  8011da:	00 
  8011db:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8011e2:	00 
  8011e3:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  8011ea:	e8 41 ee ff ff       	call   800030 <__panic>
    cprintf("wait returns %d\n", ret);
  8011ef:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011f3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011f7:	c7 04 24 14 16 80 00 	movl   $0x801614,(%esp)
  8011fe:	e8 18 ef ff ff       	call   80011b <cprintf>

    cprintf("spin may pass.\n");
  801203:	c7 04 24 25 16 80 00 	movl   $0x801625,(%esp)
  80120a:	e8 0c ef ff ff       	call   80011b <cprintf>
    return 0;
