...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004a:	c7 04 24 60 11 80 00 	movl   $0x801160,(%esp)
  ...
  800063:	e8 80 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  800068:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009a:	c7 04 24 7c 11 80 00 	movl   $0x80117c,(%esp)
  ...
  8000b3:	e8 30 00 00 00       	call   8000e8 <vcprintf>
    cprintf("\n");
  8000b8:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
...
exit(int error_code) {
  ...
  800311:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80052f:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800693:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  800797:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  80079e:	00 
  ...
  8007c3:	75 05                	jne    8007ca <vprintfmt+0x1ae>
                p = "(null)";
  8007c5:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e9:	e8 94 f2 ff ff       	call   800382 <getpid>
  8010ee:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f2:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  8010f9:	e8 1d f0 ff ff       	call   80011b <cprintf>
    for (i = 0; i < 5; i ++) {
  8010fe:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801105:	00 
  801106:	eb 27                	jmp    80112f <main+0x4f>
        yield();
  801108:	e8 55 f2 ff ff       	call   800362 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  80110d:	e8 70 f2 ff ff       	call   800382 <getpid>
  801112:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801116:	89 54 24 08          	mov    %edx,0x8(%esp)
  80111a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80111e:	c7 04 24 5c 14 80 00 	movl   $0x80145c,(%esp)
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  80112a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80112f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801134:	7e d2                	jle    801108 <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801136:	e8 47 f2 ff ff       	call   800382 <getpid>
  80113b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80113f:	c7 04 24 7f 14 80 00 	movl   $0x80147f,(%esp)
  801146:	e8 d0 ef ff ff       	call   80011b <cprintf>
    cprintf("yield pass.\n");
  80114b:	c7 04 24 98 14 80 00 	movl   $0x801498,(%esp)
  801152:	e8 c4 ef ff ff       	call   80011b <cprintf>
    return 0;
