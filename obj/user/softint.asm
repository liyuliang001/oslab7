...
main(void) {
  ...
  8010e6:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8010e9:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8010eb:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  8010f2:	00 
  8010f3:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8010fa:	00 
  8010fb:	c7 04 24 0b 14 80 00 	movl   $0x80140b,(%esp)
  801102:	e8 29 ef ff ff       	call   800030 <__panic>
