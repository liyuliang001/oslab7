...
main(void) {
  ...
  8010f0:	00 
  8010f1:	eb 60                	jmp    801153 <main+0x73>
        if ((pid = fork()) == 0) {
  8010f3:	e8 27 f2 ff ff       	call   80031f <fork>
  8010f8:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010fc:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801101:	75 20                	jne    801123 <main+0x43>
            cprintf("I am child %d\n", n);
  801103:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801107:	89 44 24 04          	mov    %eax,0x4(%esp)
  80110b:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  801112:	e8 04 f0 ff ff       	call   80011b <cprintf>
            exit(0);
  801117:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80111e:	e8 dd f1 ff ff       	call   800300 <exit>
        }
        assert(pid > 0);
  801123:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801128:	7f 24                	jg     80114e <main+0x6e>
  80112a:	c7 44 24 0c f3 14 80 	movl   $0x8014f3,0xc(%esp)
  801131:	00 
  801132:	c7 44 24 08 fb 14 80 	movl   $0x8014fb,0x8(%esp)
  801139:	00 
  80113a:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801141:	00 
  801142:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  801149:	e8 e2 ee ff ff       	call   800030 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  80114e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801153:	a1 e0 14 80 00       	mov    0x8014e0,%eax
  801158:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80115c:	7c 95                	jl     8010f3 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  80115e:	a1 e0 14 80 00       	mov    0x8014e0,%eax
  801163:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801167:	7e 4e                	jle    8011b7 <main+0xd7>
        panic("fork claimed to work %d times!\n", n);
  801169:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80116d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801171:	c7 44 24 08 20 15 80 	movl   $0x801520,0x8(%esp)
  801178:	00 
  801179:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801180:	00 
  801181:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  801188:	e8 a3 ee ff ff       	call   800030 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  80118d:	e8 9a f1 ff ff       	call   80032c <wait>
  801192:	85 c0                	test   %eax,%eax
  801194:	74 1c                	je     8011b2 <main+0xd2>
            panic("wait stopped early\n");
  801196:	c7 44 24 08 40 15 80 	movl   $0x801540,0x8(%esp)
  80119d:	00 
  80119e:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8011a5:	00 
  8011a6:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  8011ad:	e8 7e ee ff ff       	call   800030 <__panic>
    ...
    for (; n > 0; n --) {
  8011b2:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  8011b7:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8011bc:	7f cf                	jg     80118d <main+0xad>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8011be:	e8 69 f1 ff ff       	call   80032c <wait>
  8011c3:	85 c0                	test   %eax,%eax
  8011c5:	75 1c                	jne    8011e3 <main+0x103>
        panic("wait got too many\n");
  8011c7:	c7 44 24 08 54 15 80 	movl   $0x801554,0x8(%esp)
  8011ce:	00 
  8011cf:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8011d6:	00 
  8011d7:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  8011de:	e8 4d ee ff ff       	call   800030 <__panic>
    }

    cprintf("forktest pass.\n");
  8011e3:	c7 04 24 67 15 80 00 	movl   $0x801567,(%esp)
  8011ea:	e8 2c ef ff ff       	call   80011b <cprintf>
    return 0;
